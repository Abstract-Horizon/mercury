 ...
 */
public class StaticMaildirMessage extends LazyParsingMessage implements FilenameFilter, FileProvider,  Comparable<StaticMaildirMessage> {
    ...
    protected StaticMaildirFolder maildirFolder;
     ...
     * @throws IOException
     */
    protected StaticMaildirMessage(StaticMaildirFolder folder, MimeMessage message, int msgnum) throws MessagingException, IOException {
        super(message);
     ...
     * @throws MessagingException
     */
    public StaticMaildirMessage(StaticMaildirFolder folder, File file, int msgnum, boolean initialise) throws MessagingException {
        super(folder, msgnum);
        this.maildirFolder = folder;
     ...
     * @throws MessagingException
     */
    public StaticMaildirMessage(StaticMaildirFolder folder, File file, int msgnum) throws MessagingException {
    ...
    public static String baseNameFromFile(File file) {
        ...
        int i = name.lastIndexOf(StaticMaildirMessage.FLAGS_SEPERATOR);
        if (i > 0) {
     ...
     */
    public int compareTo(StaticMaildirMessage o) {
        String s1 = baseName;
